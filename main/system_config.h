...
// Motor Control Pins (IBT-2)
#define PIN_MOTOR_RPWM CONFIG_MOTOR_GPIO_RPWM
#define PIN_MOTOR_LPWM CONFIG_MOTOR_GPIO_LPWM
#define PIN_MOTOR_R_EN CONFIG_MOTOR_GPIO_R_EN
#define PIN_MOTOR_L_EN CONFIG_MOTOR_GPIO_L_EN
